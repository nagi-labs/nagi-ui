...
const verified = definitions.filter(({ definition }) => definition.status === "verified").length
const draft = definitions.length - verified
console.log(`Component Definitions: ${definitions.length} total, ${verified} verified, ${draft} draft.`)
