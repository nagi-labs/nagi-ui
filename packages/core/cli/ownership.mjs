...
export const components = {
  ...
  checkbox: { dir: "blueprints/checkbox", files: ["NagiCheckbox.vue"] },
  ...
  fieldset: { dir: "blueprints/fieldset", files: ["NagiFieldset.vue"] },
  input: { dir: "blueprints/input", files: ["NagiInput.vue"] },
  listbox: { dir: "blueprints/listbox", files: ["Listbox.vue"] },
  meter: { dir: "blueprints/meter", files: ["NagiMeter.vue"] },
  popover: { dir: "blueprints/popover", files: ["NagiPopover.vue"] },
  progress: { dir: "blueprints/progress", files: ["NagiProgress.vue"] },
  radio: { dir: "blueprints/radio", files: ["NagiRadio.vue"] },
