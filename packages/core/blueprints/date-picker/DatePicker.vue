...
@media (forced-colors: active) {
  ...
  .n-date-picker > .unit > .table > .rowgroup.-dates > .row > .cell > .button.-day:focus-visible {
    outline: 2px solid Highlight;
    outline-offset: 2px;
  }
  .n-date-picker > .unit > .table > .rowgroup.-dates > .row > .cell[aria-selected="true"] > .button.-day {
