...
The adoption choices record how a component invokes the surface and who owns
...
and the distinct invocation choices. ShadowRoot and nested-popup focus remain
