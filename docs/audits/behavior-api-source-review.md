...
| --- | --- | --- | --- |
| [`accordion.ts`](../../packages/core/src/accordion.ts) | Accordion | Publishable | Keeps exclusive/multiple normalization beside native `details`; the Blueprint retains item markup. |
...
| [`avatar.ts`](../../packages/core/src/avatar.ts) | Avatar | Publishable | Owns image failure races and fallback derivation; rendered image/fallback anatomy remains visible. |
| [`button.ts`](../../packages/core/src/button.ts) | Button | Publishable | Contains only Nagi's focusable-disabled policy; ordinary native activation remains browser-owned. |
...
| [`context-menu.ts`](../../packages/core/src/context-menu.ts) | ContextMenu | Publishable | Pointer, long-press, and virtual-anchor sessions stay ContextMenu-specific and expose named lifecycle transitions. |
...
| [`menubar.ts`](../../packages/core/src/menubar.ts) | Menubar | Publishable | Roving top-level ownership composes Menu without merging their different keyboard contracts. |
...
| [`navigation-menu.ts`](../../packages/core/src/navigation-menu.ts) | NavigationMenu | Publishable | Hover, focus, and activation causes remain explicit product policy over native links and popovers. |
...
| [`number-field.ts`](../../packages/core/src/number-field.ts) | NumberField | Publishable | Delegates parsing constraints and stepping to the native number input, then synchronizes the nullable model. |
| [`otp-field.ts`](../../packages/core/src/otp-field.ts) | OTPField | Publishable | One native input owns editing while normalization and decorative-cell derivation remain explicit. |
...
| [`range-slider.ts`](../../packages/core/src/range-slider.ts) | RangeSlider | Publishable | Two native range inputs retain native constraints; rail interaction and ordered-model repair stay component-specific. |
| [`resizable.ts`](../../packages/core/src/resizable.ts) | Resizable | Publishable | Separator keyboard/pointer behavior and measurable parent geometry are explicit, without a generic drag framework. |
| [`select.ts`](../../packages/core/src/select.ts) | Select | Publishable | Reads browser-selected fallback and reset state rather than reproducing native option selection rules. |
| [`slider.ts`](../../packages/core/src/slider.ts) | Slider | Publishable | Reads browser range sanitization after DOM updates and adds no speculative slider state machine. |
...
| [`toast.ts`](../../packages/core/src/toast.ts) | Toast manager and public binding | Publishable | Data/timers, Toast-specific document coordination, and renderer focus repair are separated without a generic coordinator. |
...
| [`toggle.ts`](../../packages/core/src/toggle.ts) | Toggle | Publishable | Keeps native button activation and exposes only controlled pressed/disabled synchronization. |
