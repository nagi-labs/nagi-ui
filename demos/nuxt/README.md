...
Renders the focused `demos/native-popover-dropdown.vue` proof inside a Nuxt app under
...
The demo SFCs (`../native-popover-dropdown.vue`, `app.vue`, and
`components/dropdown-demo.vue`) pass `nagi-css check`.
