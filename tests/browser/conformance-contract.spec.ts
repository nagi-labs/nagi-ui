...
datePickerContract({
  ...
  outsideButtonName: "Outside owned DatePicker",
  navigation: {
    triggerName: "Choose owned keyboard date",
    calendarName: "Owned keyboard date calendar",
    selectedDateName: "Friday, July 24, 2026",
    arrowRightDateName: "Saturday, July 25, 2026",
    arrowDownDateName: "Saturday, August 1, 2026",
    homeDateName: "Sunday, July 26, 2026",
  ...
  disabled: {
    fieldName: "Owned disabled date",
    triggerName: "Choose owned disabled date",
    modelStatusName: "Owned disabled date model",
    externalUpdateName: "Set owned disabled date to July 25",
  },
  readOnly: {
    fieldName: "Owned readonly date",
    triggerName: "Choose owned readonly date",
    calendarName: "Owned readonly date calendar",
    selectedDateName: "Friday, July 24, 2026",
    nextDateName: "Saturday, July 25, 2026",
    modelStatusName: "Owned readonly date model",
  },
  controlled: {
    fieldName: "Owned controlled date",
    triggerName: "Choose owned controlled date",
    calendarName: "Owned controlled date calendar",
    selectedDateName: "Friday, July 24, 2026",
    nextDateName: "Saturday, July 25, 2026",
    modelStatusName: "Owned controlled date model",
    openStatusName: "Owned controlled date open",
    dateRequestsStatusName: "Owned controlled date requests",
    openRequestsStatusName: "Owned controlled open requests",
    acceptOpenName: "Accept owned controlled date open",
    acceptCloseName: "Accept owned controlled date close",
  },
  submission: {
