...
import CodeDisclosure from "./code-disclosure.vue";
import ComponentDocumentation from "./component-documentation.vue";
...
<template>
  <component-documentation>
    ...
    <template #basic-description>
      <span class="text">{{ basicGuidance }}</span>
    </template>
    <template #basic>
    ...
    >
      ...
      <span class="text">
        ...
        <inline-code>button-example.vue</inline-code> surface, <inline-code>n-button</inline-code> is
